...
export const Footer = () => {
	return (
        <div className="h-[300px] overflow-hidden rounded-t-2xl over text-foreground box-border outline-none shadow-medium transition-transform-background motion-reduce:transition-none border-transparent dark:bg-default-400/10 backdrop-blur-lg backdrop-saturate-[1.8]">
            <div className='flex absolute mt-[200px] w-[100vw] justify-center'>
